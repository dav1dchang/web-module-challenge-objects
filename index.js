...
console.log(createMenuItem('Salad', 10, 'Lunch'))//invoking function and logging to display/verify
...
function addReview(reviews){
    ...
    return reviews.push({name: 'David', rating: 5, feedback:'Food was good and they have great taste in music.'});
  
}//function 
console.log(addReview(reviews))//invoking function

/* Task 5: Add the following feedback to Reyna's rating - "this place is chill with really cool people, great for getting work done on weekdays"*/

function addReynaReview(reviews, index){

    return reviews[index].feedback = 'this place is chill with really cool people, great for getting work done on weekdays'

}//function
console.log(addReynaReview(reviews, 7))//invoking function
console.log(reviews)//verifying the value part of the key feedback in the object 'reyna' was changed.
